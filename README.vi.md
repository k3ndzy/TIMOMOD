<p align="center">
  <img src="docs/images/app-icon.png" width="132" alt="Biểu tượng ứng dụng TIMO MOD">
</p>
...
> [!WARNING]
> TIMO MOD là phần mềm nghiên cứu để quản lý thiết bị cá nhân. Chỉ sử dụng trên thiết bị và dữ liệu thuộc quyền sở hữu của bạn, đồng thời luôn sao lưu trước khi thay đổi dữ liệu ứng dụng.

## Giao diện

<p align="center">
  <img src="docs/images/home.png" width="245" alt="Trang chủ TIMO MOD">
  &nbsp;
  <img src="docs/images/patches.png" width="245" alt="Patch TIMO MOD">
  &nbsp;
  <img src="docs/images/cleaner.png" width="245" alt="Dọn dẹp TIMO MOD">
</p>

## Có gì mới trong 1.0.1

- **Patch workspace v2** — tạo patch bằng cây thư mục theo bundle trong `Trên iPhone của tôi/TIMO MOD/Patches`; khi Áp dụng hoặc Xuất, app tự đồng bộ toàn bộ workspace.
...
- Tạo và nhập dự án patch `.timo` theo bundle, hỗ trợ nhiều quy tắc, tệp/thư mục, mật khẩu tùy chọn và nhập từ Files hoặc liên kết website bảo mật.
...
- Nhập gói hình nền `.tendies`, xác thực payload và chỉ reset nội dung do TIMO MOD cài đặt.
- TIMO MOD không cài jailbreak, bootstrap hay daemon thường trú và không inject mã vào ứng dụng bên thứ ba. Do ứng dụng vẫn dùng khai thác thiết bị và có thể sửa dữ liệu app, không thể bảo đảm vượt qua mọi cơ chế kiểm tra tính toàn vẹn hoặc phát hiện jailbreak.
...
TIMO MOD được phát triển và thiết kế bởi [TIMO MOD](https://x.com/timomod). Xem [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md) để biết các dự án và nhà phát triển nền tảng đã được sử dụng/tham khảo.

## Giấy phép

Phần mã gốc của TIMO MOD được phát hành theo [GNU General Public License v3.0](LICENSE). Thành phần của bên thứ ba vẫn tuân theo bản quyền và điều khoản của dự án nguồn tương ứng; xem [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md).
