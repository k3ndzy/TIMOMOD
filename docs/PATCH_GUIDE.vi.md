...
Patch của TIMO MOD nhắm đến ứng dụng bằng bundle identifier ổn định. Gói patch không lưu UUID container vì UUID này thay đổi theo từng máy và mỗi lần cài lại ứng dụng.

## Cấu trúc workspace

Khi tạo patch tên `ABC` cho bundle `com.abc.xyz`, TIMO MOD tạo cây thư mục có thể chỉnh sửa như sau:
